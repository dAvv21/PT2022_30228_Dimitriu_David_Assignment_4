...
public class EditProductView extends JFrame {
    ...
    public EditProductView() {
        ...
        this.createProductBtn = new JButton("EDIT PRODUCT");
        ...
        nameTxt.setBounds(628, 95, 208, 38);
        panel.add(nameTxt);
        ...
        priceTxt.setBounds(355, 345, 208, 38);
        panel.add(priceTxt);
        ...
        fatTxt.setBounds(355, 220, 208, 38);
        panel.add(fatTxt);
        ...
        proteinTxt.setBounds(628, 220, 208, 38);
        panel.add(proteinTxt);

        JLabel lblPleaseIntroduceThe = new JLabel("Please introduce the name of the product you want to edit : ");
        lblPleaseIntroduceThe.setFont(new Font("Arial", Font.PLAIN, 19));
        lblPleaseIntroduceThe.setBounds(96, 97, 526, 37);
    ...
    public void editProductBtn(ActionListener actionListener){
